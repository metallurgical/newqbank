...
if(isset($_POST['daftar']))
{
			...
			{
				echo "<script language=javascript>alert('Upload file berjaya.');window.location='question-list.php';</script>";
			}
			else
			{
				echo "<script language=javascript>alert('Upload file tidak berjaya. Sila cuba lagi.');window.location='register_question.php';</script>";
			}
													...
													<fieldset>
														<table width="750" border="0" align="center" cellpadding="3" cellspacing="1">
															...
															<tr>
																<td align="right">&nbsp;</td>
																<td align="left">
																	<button type="submit" name="daftar" class="butangkecil"><span>MUAT NAIK</span></button>
