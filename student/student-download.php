...
$sql_student = "SELECT * FROM student WHERE student_id = '".$_SESSION['student_id']."'";
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0" id="content">
						<tr>
							<td valign="top">
								...
								<div class="sub-tajuk-merah" style="width:730px;margin-top:20px"><strong>Log Masuk : <?php echo ucwords($rows_student['student_name']);?></strong></div>
										...
										<td align="left">
											<table width="750" border="0" cellspacing="1" cellpadding="5" bgcolor="#CCCCCC" class="display" id="example">
												...
												<tr bgcolor="#FFFFFF">
													...
													<td align="center"><a href="question-download.php?id=<?php echo $rows_question['question_id'];?>">Download</a>
													</td>
												</tr>
