										...
										<td align="left">
											<table width="750" border="0" cellspacing="1" cellpadding="5" bgcolor="#CCCCCC" class="display" id="example">
												...
												<tr bgcolor="#FFFFFF">
													...
													<td align="left"><a href="view-question.php?id=<?php echo $rows_question['question_id'];?>"><?php echo ucwords($rows_question['question_name']);?></a></td>
													<td align="center"><?php echo $rows_question['question_category'];?></td>
													<td align="center"><?php echo $rows_question['question_form'];?></td>
													<td align="center"><a href="question-list.php?action=delete&id=<?php echo $rows_question['question_id'];?>"><img src="../images/delete.png" width="16" height="16" border="0" /></a>
