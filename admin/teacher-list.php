...
{
	$sql_padam_teacher = "SELECT * FROM teacher WHERE teacher_id = ".$_GET['id']."";
	if($result_padam_teacher = $connect->query($sql_padam_teacher))
	{
		if($total_padam_teacher = $result_padam_teacher->num_rows)
		{
			$sql_padam_teacher = "DELETE FROM teacher WHERE teacher_id = '".$_GET['id']."'";
			if($result_padam_teacher = $connect->query($sql_padam_teacher))
			{
				echo "<script language=javascript>alert('Maklumat guru berjaya dipadam.');window.location='teacher-list.php';</script>";
			}
			else
			{
				echo "<script language=javascript>alert('Maklumat guru tidak berjaya dipadam. Sila cuba lagi.');window.location='teacher-list.php';</script>";
			}
		}
		else
		{
						...
						<tr>
							<td valign="top">
								...
								<table width="750" border="0" align="center" cellpadding="3" cellspacing="1">
									<tr>
										<td align="left"><div class="sub-tajuk-borang bulat">Senarai Guru</div></td>
									</tr>
									<tr>
										<td align="left">
											<table width="750" border="0" cellspacing="1" cellpadding="5" bgcolor="#CCCCCC" class="display" id="example">
												...
												<tr bgcolor="#FFFFFF">
													...
													<td align="center"><a href="view-teacher.php?id=<?php echo $rows_teacher['teacher_id'];?>"><?php echo ucwords($rows_teacher['teacher_name']);?></a></td>
													<td align="center"><?php echo $rows_teacher['teacher_username'];?></td>
													<td align="center"><?php echo $rows_teacher['teacher_staffid'];?></td>
													<td align="center">
														<a href="edit-teacher.php?id=<?php echo $rows_teacher['teacher_id'];?>"><img src="../images/edit.png" width="16" height="16" border="0" /></a>
														<a href="teacher-list.php?action=delete&id=<?php echo $rows_teacher['teacher_id'];?>"><img src="../images/delete.png" width="16" height="16" border="0" /></a>
													</td>
												</tr>
												<?php } while($rows_teacher = $result_teacher->fetch_array()); } ?>
											</table>
										</td>
									</tr>
								</table>							
