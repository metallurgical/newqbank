												...
												<form id="borang_pengesahan_pembayaran" name="borang_pengesahan_pembayaran" method="post" class="borang" style="padding-top:20px">
													<fieldset>
														<table width="750" border="0" align="center" cellpadding="3" cellspacing="1">
															<tr>
																<td colspan="2" align="center"><div class="sub-tajuk-kelabu">PENGURUSAN GURU</div></td>
															</tr>
															<tr>
															...
															<tr align="center">
																<td>
																	<a href="register.php" class='butangkecil'><span>DAFTAR</span></a>
																</td>
																<td>
																	<a href="teacher-list.php" class='butangkecil'><span>SENARAI GURU</span></a>
																</td>
															</tr>
														</table>
													</fieldset>
