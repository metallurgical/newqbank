												...
												<form id="borang_pengesahan_pembayaran" name="borang_pengesahan_pembayaran" method="post" class="borang" style="padding-top:20px">
													<fieldset>
														<table width="750" border="0" align="center" cellpadding="3" cellspacing="1">
															<tr>
																<td colspan="2" align="center"><div class="sub-tajuk-kelabu">PENGURUSAN KELAS </div></td>
															</tr>
															<tr>
															...
															<tr align="center">
																<td>
																	<a href="register_class.php" class='butangkecil'><span>DAFTAR KELAS</span></a>
																</td>
																<td>
																	<a href="class-list.php" class='butangkecil'><span>SENARAI KELAS</span></a>
																</td>
															</tr>
														</table>
													</fieldset>
